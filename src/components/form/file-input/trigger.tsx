...
export function Trigger() {
  ...
  return (
    <label
      className="group flex-1 shadow-sm cursor-pointer flex flex-col items-center gap-3 rounded-lg border border-zinc-300 px-6 py-4 text-center text-zinc-500 hover:border-violet-200 hover:bg-violet-25 hover:to-violet-500"
      htmlFor={id}
    >
