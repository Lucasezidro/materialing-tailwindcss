  ...
  variants: {
    state: {
      ...
      error: {
        ...
        icon: 'border-error-50 bg-error-100 text-error-600 dark:bg-error-500/5 dark:border-error-500/30 dark:text-error-400 dark:border-zinc-700 dark-bg-zinc-800 dark:text-zinc-500',
        deleteButton:
      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            ...
            <span className="text-sm text-error-700 dark:text-error-500">
              {name}
            </span>
          </div>
          ...
          <button
            type="button"
            className="text-sm font-semibold text-error-700 dark:text-error-400 hover:text-error-900 dark:hover:text-error-300"
          >
            Try again
          </button>
        </div>
